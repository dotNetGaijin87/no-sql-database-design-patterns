...
`OnlineStore` starts as the naive relational port below and, migration by migration, becomes the idiomatic document model further down. Each collection is drawn as a document box; **embedded** sub-documents / arrays are the **nested boxes** (`items[]`, `card{}`, `spec{}`, …), and **references** are the lines, labelled with cardinality (`N:1` / `N:N` / `tree`).
...
<p align="center">
  <img src="docs/images/model-before.svg" alt="OnlineStore — the naive relational port: flat collections joined by string foreign keys" width="100%">
</p>
...
<p align="center">
  <img src="docs/images/model-after.svg" alt="OnlineStore — the document model: embedded sub-documents as nested boxes, id references with N:1/N:N cardinality, and a category tree" width="100%">
</p>
